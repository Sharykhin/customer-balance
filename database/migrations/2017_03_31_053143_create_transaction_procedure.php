...
class CreateTransactionProcedure extends Migration
{
    ...
    {
        $procedure = <<<SQL
            CREATE PROCEDURE make_transaction(IN amount DECIMAL(8,2), IN currency VARCHAR(45), IN operation_type VARCHAR(45), IN customer_id INT)
             BEGIN
             ...
             IF operation_type = 'withdrawal' AND amount > customer_balance THEN
                ...
                SET MESSAGE_TEXT = 'You can not withdraw more that you have on your balance';
